...
//
//@Service
//public class NewParentMessageNotificationProcessor {
//    private static final Logger LOGGER = LoggerFactory.getLogger(NewParentMessageNotificationProcessor.class);
//
//    private List<Consumer<ParentMessageDtoGet>> listeners = new CopyOnWriteArrayList< >();
//
//    public void register(Consumer < ParentMessageDtoGet > listener) {
...
//
//    public void process(ParentMessageDtoGet event) {
